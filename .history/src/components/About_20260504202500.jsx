  ...
  return (
    <div className="about-container">
      ...
      <div className="social-icons">
        ...
        <a href="[https://www.linkedin.com/in/yee-mon-thant-15973a2b9](https://www.linkedin.com/in/yee-mon-thant-15973a2b9)?" target="_blank" rel="noreferrer">
          <i className="fa-brands fa-linkedin" style={{ fontSize: 24 }}></i>
        </a>
        <a href="[https://github.com/Lucy-oop](https://github.com/Lucy-oop)" target="_blank" rel="noreferrer">
          <i className="fa-brands fa-github" style={{ fontSize: 24 }}></i>
        </a>

        <a href="[https://www.facebook.com/yeemonthant0611](https://www.facebook.com/yeemonthant0611)" target="_blank" rel="noreferrer">
          <i className="fa-brands fa-facebook" style={{ fontSize: 24 }}></i>
        </a>
        <a href="[https://www.instagram.com/yeemon7631?igsh=MWt2ZmtveXI0cWcwMg=](https://www.instagram.com/yeemon7631?igsh=MWt2ZmtveXI0cWcwMg=)" target="_blank" rel="noreferrer">
