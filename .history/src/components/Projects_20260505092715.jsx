...
export default function Projects() {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          setInView(false); // Resets the animation when you scroll away
        }
      },
  ...
  return (
    <div className="project-container" ref={sectionRef}>
      ...
      {/* THE NEW FLOATING HINT */}
      <div className={`preview-hint ${inView ? "animate-in" : ""} ${preview ? "hide" : ""}`}>
        <span className="hint-icon">✧</span>
        <p>Hover or click a project<br/>to see the preview</p>
      </div>
